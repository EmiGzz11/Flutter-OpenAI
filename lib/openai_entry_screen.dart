            ...
            children: [
              ...
              Stack(
                children: [
                  ...
                  Positioned(
                    left:
                        0, // Ajusta la posición horizontal de la caja (puedes cambiarlo)
                    right:
                        0, // Ajusta la posición horizontal de la caja (puedes cambiarlo)
                    ...
                    child: Container(
                      height: 500,
                      color: Color(
                          0x80000000), // Color negro semi-transparente (80% opaco)
                    ),
                  ),
                  const Positioned(
                    top: 0,
              ...
              Padding(
                  ...
                  child: DropdownButtonFormField<String>(
                    ...
                    decoration: const InputDecoration(
                        labelText: "Musculo 💪",
                        hintText:
                            "Selecciona el musculo que deseas entrenar hoy",
                        labelStyle: TextStyle(
                            color: Colors.black,
                            fontWeight: FontWeight.bold,
                            fontSize: 18,
